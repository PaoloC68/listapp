# Django settings for testappa project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': SITE_ROOT + '/app.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^8@%x2*-v!w14+6x56kj*^k_j2+41yql%)o7%1=apr*-375%oe'
